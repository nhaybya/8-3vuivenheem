...
const messages = [
    "Gửi đến bann iuu tuyệt vời nhất trong cuộc đời Tớ, Cậu mang đến niềm vui và hạnh phúc cho Tớ mỗi ngày.",
    "Nụ cười của Cậu thắp sáng thế giới của Tớ, và tình yêu của Cậu lấp đầy trái tim Tớ bằng sự ấm áp.",
    "Vào ngày đặc biệt này, Tớ muốn Cậu biết Cậu có ý nghĩa như thế nào đối với Tớ.",
    "Cậu không chỉ là bạn gái của Tớ, Cậu là Tớ thân nhất của Tớ, là người bạn tâm giao và là tất cả của Tớ.",
    "Tớ trân trọng từng khoảnh khắc chúng ta bên nhau, và Tớ mong muốn tạo ra nhiều kỷ niệm đẹp hơn nữa.",
    "Chúc mừng Ngày Phụ nữ, tình yêu của Tớ! Cậu xứng đáng có được tất cả hạnh phúc trên thế giới này."
];
